...
/// <summary>
/// Validador para FichaFresagemDto.
/// </summary>
public class FichaFresagemValidator : AbstractValidator<FichaFresagemDto>
{
    public FichaFresagemValidator()
    {
        ...
        RuleForEach(f => f.Apontamentos)
            .SetValidator(new ApontamentoFresagemValidator());
