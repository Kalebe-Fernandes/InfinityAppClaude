...
/// <summary>
/// Validador para ApontamentoMicrorevestimentoDto.
/// </summary>
public class ApontamentoMicrorevestimentoValidator : AbstractValidator<ApontamentoMicrorevestimentoDto>
{
    public ApontamentoMicrorevestimentoValidator()
    {
        RuleFor(a => a.Lado)
            .NotEmpty()
        ...
        RuleFor(a => a.Materiais)
            .NotEmpty()
            .WithMessage("O apontamento deve ter pelo menos um material.");

        RuleForEach(a => a.Materiais)
            .SetValidator(new MaterialQuantidadeValidator());
    }
}
