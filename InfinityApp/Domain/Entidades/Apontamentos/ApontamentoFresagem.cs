...
/// <summary>
/// Representa um apontamento de Fresagem (por área com espessura).
/// </summary>
public class ApontamentoFresagem : EntidadeBase
{
    public Guid FichaFresagemId { get; set; }
    public virtual FichaFresagem FichaFresagem { get; set; } = null!;
