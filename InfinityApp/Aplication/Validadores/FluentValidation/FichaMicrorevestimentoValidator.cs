...
/// <summary>
/// Validador para FichaMicrorevestimentoDto.
/// </summary>
public class FichaMicrorevestimentoValidator : AbstractValidator<FichaMicrorevestimentoDto>
{
    public FichaMicrorevestimentoValidator()
    {
        ...
        RuleForEach(f => f.Apontamentos)
            .SetValidator(new ApontamentoMicrorevestimentoValidator());
