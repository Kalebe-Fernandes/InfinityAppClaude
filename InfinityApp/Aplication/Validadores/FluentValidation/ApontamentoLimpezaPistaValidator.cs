...
/// <summary>
/// Validador para ApontamentoLimpezaPistaDto.
/// </summary>
public class ApontamentoLimpezaPistaValidator : AbstractValidator<ApontamentoLimpezaPistaDto>
{
    public ApontamentoLimpezaPistaValidator()
    {
        RuleFor(a => a.Lado)
            .NotEmpty()
