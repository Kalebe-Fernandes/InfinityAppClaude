...
/// <summary>
/// Validador para FichaCBUQDto.
/// </summary>
public class FichaCBUQValidator : AbstractValidator<FichaCBUQDto>
{
    public FichaCBUQValidator()
    {
        ...
        RuleForEach(f => f.Apontamentos)
            .SetValidator(new ApontamentoCBUQValidator());
